...
This Terms of Service Agreement (the "Agreement") is entered into between [Phil Hendrik Hempel] ("Bot Owner") and the user ("User") of the [OrbitXP] Discord bot (the "Bot").
...
const TermsOfService = () => {
  return (
    <div className="bg-white dark:bg-gray-800 shadow-md rounded-lg p-8 prose dark:prose-invert max-w-none">
